...
contract ERC20MuToken is Context, ERC20Burnable, ERC20Pausable, AccessControlEnumerable, Ownable, ERC721Holder {
    ...
    constructor(
        ...
        lastRemainSupply = _lastRemainSupply;
    ...
    function transfer(
        ...
        else if(balanceOf(blackholeAddress) < (initialSupply - lastRemainSupply)) {
